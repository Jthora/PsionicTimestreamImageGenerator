...
//
//class PsionicDataParser_Old {
//
//    static let main:PsionicDataParser_Old = PsionicDataParser_Old()
//
//
//    let defaultFileName:String = "SiderealVedicEphemeris_GalacticCenter_1978-2062_Parse-base360"
//    let defaultFileType:String = ".txt"
//
//    var fileContent:String? = nil
//    var dataContent:[Planet:[PlanetState]] = [Planet:[PlanetState]]()
...
//            for signAndDegreesAsString in columns {
//                guard let planet = Planet.from(index: columnIndex) else {
//                    print("ERROR: parser can't translate Planet from Index: \(columnIndex)")
//                    continue
//                }
//
//                let signAndDegrees:[String] = signAndDegreesAsString.components(separatedBy: " ")
//                let degreesAsString:String = signAndDegrees[1]
//                guard let degrees = Float(degreesAsString) else {
//                    print("ERROR: parser at rowIndex[\(rowIndex)] and columnIndex[\(columnIndex)] can't convert String to Float: \(degreesAsString)")
//                    continue
//                }
//
//                if dataContent[planet] == nil {
...
//                }
//
//                let planetState = PlanetState(degrees: degrees, retrogradeState: retrogradeState, speed: speed)
//
//                dataContent[planet]?.append(planetState)
//
//                columnIndex += 1
